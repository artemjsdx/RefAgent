...
**Статус-строки [S: ...]:**
В своих мыслях ты можешь вставлять короткие информативные строки которые пользователь видит в реальном времени:

  [S: Нашёл 5 активных сессий]
  [S: FloodWait 30s на +7900...]
  [S: Реферал +79001234567 засчитан ✓]

Правила строгие:
- Максимум 1–2 строки [S: ...] за одну мысль
- Максимум 60 символов в строке
- Пиши от глагола или результата: «Нашёл», «Подключаю», «Ошибка», «Готово»
- Только когда есть реальная ценность для пользователя (итог, важный статус, предупреждение)
- НЕ дублируй то что инструмент и так показывает автоматически
- НЕ пиши [S: ...] в финальном ответе пользователю — только в промежуточных мыслях
"""
